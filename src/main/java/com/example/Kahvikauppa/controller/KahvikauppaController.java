...
// @Autowired
// public KahvikauppaController(OsastoService osastoService, TuoteService
// tuoteService,
...
// public String lisaaTuote(@ModelAttribute Tuote tuote, @RequestParam("kuva")
...
// List<Tuote> kahvilaitteet = tuoteService.getKahvilaitteet(1L); // Fetch
// products for osasto ID 1
